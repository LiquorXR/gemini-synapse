...
show_main_menu() {
  while true; do
    ...
    echo -e "${GREEN}"
    echo ' ____                _       _   ____                                   '
    echo ' / ___| ___ _ __ ___ (_)_ __ (_) / ___| _   _ _ __   __ _ _ __  ___  ___ '
    echo '| |  _ / _ \ '_ ` _ \| | '_ \| | \___ \| | | | '_ \ / _` | '_ \/ __|/ _ \'
    echo '| |_| |  __/ | | | | | | | | | |  ___) | |_| | | | | (_| | |_) \__ \  __/ '
    echo ' \____|\___|_| |_| |_|_|_| |_|_| |____/ \__, |_| |_|\__,_| .__/|___/\___|'
    echo '                                        |___/            |_|             '
    echo -e "${NC}"
    echo -e "${BLUE}=========================================================${NC}"
