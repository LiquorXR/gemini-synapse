...
show_main_menu() {
  while true; do
    ...
    echo -e "${CYAN} / ___| ___ _ __ ___ (_)_ __ (_) / ___| _   _ _ __   __ _ _ __  ___  ___   ${NC}"
    echo -e "${CYAN}| |  _ / _ \ '_ ` _ \| | '_ \| | \___ \| | | | '_ \ / _` | '_ \/ __|/ _ \  ${NC}"
    echo -e "${CYAN}| |_| |  __/ | | | | | | | | | |  ___) | |_| | | | | (_| | |_) \__ \  __/  ${NC}"
    echo -e "${CYAN} \____|\___|_| |_| |_|_|_| |_|_| |____/ \__, |_| |_|\__,_| .__/|___/\___|  ${NC}"
